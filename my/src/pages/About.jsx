      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className={`text-lg leading-relaxed text-justify ${textPrimary} mb-4`}>
            ...
            , a Final Year undergraduateStudent in B.sc (Hons) in CIS at Faculty of Computing with a passion
            for building scalable and user-centric applications. My development
            journey began during my first year in University and Internship in my third year, starting with fundamental Data
            Structures and Algorithms, which laid a strong foundation for my
            technical growth and Web Development and Full Stack Development Site.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className={textPrimary}>
                  Start and Grow Warna Digital Solution and Web Development and Designing Facebook Post
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className={textPrimary}>
                  Complete MERN stack mastery with deployment experience & Website Designing / Deploy
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Watch My Designs <FaYoutube className="text-sm" />
            </a>
          </div>
        </div>
      </div>
